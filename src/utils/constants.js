export const weatherOptions = [
  {
    day: true,
    condition: "clear",
    url: new URL("../src/assets/day/clear.png", import.meta.url).href,
  },
  {
    day: true,
    condition: "cloudy",
    url: new URL("../src/assets/day/cloudy.png", import.meta.url).href,
  },
  {
    day: true,
    condition: "rain",
    url: new URL("../src/assets/day/rain.png", import.meta.url).href,
  },
  {
    day: true,
    condition: "storm",
    url: new URL("../src/assets/day/storm.png", import.meta.url).href,
  },
  {
    day: true,
    condition: "snow",
    url: new URL("../src/assets/day/snow.png", import.meta.url).href,
  },
  {
    day: true,
    condition: "fog",
    url: new URL("../src/assets/day/fog.png", import.meta.url).href,
  },
  {
    day: false,
    condition: "clear",
    url: new URL("../src/assets/night/clear.png", import.meta.url).href,
  },
   {
    day: false,
    condition: "cloudy",
    url: new URL("../src/assets/night/cloudy.png", import.meta.url).href,
  },
  {
    day: false,
    condition: "rain",
    url: new URL("../src/assets/night/rain.png", import.meta.url).href,
  },
   {
    day: false,
    condition: "storm",
    url: new URL("../src/assets/night/storm.png", import.meta.url).href,
  },
  {
    day: false,
    condition: "snow",
    url: new URL("../src/assets/night/snow.png", import.meta.url).href,
  },
   {
    day: false,
    condition: "fog",
    url: new URL("../src/assets/night/fog.png", import.meta.url).href,
  },
];
...
export const coordinates = {
  latitude: 44.1155584,
  longitude: -70.2119936,
};

export const APIkey = "4ee9446a2c3da3ad6b6ca9f73b7d3041";
